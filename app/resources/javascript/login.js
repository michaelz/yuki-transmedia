$(document).ready(function() {
        ...
        $.ajax({
          ...
          success: function(data) {
              ...
              if (data.status == 'success') {
                  localStorage.setItem("yuki-auth-token", data.data);
              } else {
                  $("#loginError").append('<p class="error">Login/Mot de passe non-reconnu</p>');
              }
  ...
  $(".form-item input").focusout(function() {
      if (pseudoStatus && emailStatus && pwStatus && repwStatus) {
